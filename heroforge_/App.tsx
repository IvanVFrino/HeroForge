...
import CombatTracker from './components/CombatTracker'; // Nueva importación
...
const navLinks = [
  ...
  { path: '/combat-tracker', name: 'Gestor de Combate', icon: BoltIcon }, // Nuevo enlace
...
const App: React.FC = () => {
  ...
  const isCombatTrackerActive = location.pathname === '/combat-tracker'; // Nueva condición
    ...
    <div className={`min-h-screen flex flex-col bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-800 text-slate-900 dark:text-slate-100`}>
      ...
      <main className={`flex-grow ${mainContentPadding}`}>
        <Routes>
          ...
          <Route path="/combat-tracker" element={<CombatTracker />} /> {/* Nueva Ruta */}

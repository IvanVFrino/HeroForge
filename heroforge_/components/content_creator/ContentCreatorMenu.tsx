...
import { UserGroupIcon, ShieldCheckIcon, BookOpenIcon, UsersIcon as NpcIcon, CubeIcon } from '@heroicons/react/24/outline';
...
const ContentCreatorMenu: React.FC = () => {
  const creatorSections = [
    ...
    { name: 'Clases Personalizadas', path: '/content-creator/class/new', icon: ShieldCheckIcon, description: "Forja nuevas clases de personaje y subclases." },

          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
           ...
           {selectedClassUI.spellcasting && (
            <div className="mt-4">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">Trucos Conocidos (N1): {selectedClassUI.spellcasting.knownCantrips}</p>
              <p className="text-sm text-slate-700 dark:text-slate-300">Hechizos Preparados (N1): {selectedClassUI.spellcasting.preparedSpells}</p>
              <p className="text-sm text-slate-700 dark:text-slate-300">Espacios de Hechizo (N1): {selectedClassUI.spellcasting.spellSlotsLevel1}</p>
            </div>
          )}
        </div>
      )}
